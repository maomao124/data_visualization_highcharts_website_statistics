    ...
    M(a, "Core/Axis/Axis.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Axis/AxisDefaults.js"], a["Core/Color/Color.js"], a["Core/Defaults.js"], a["Core/Foundation.js"], a["Core/Globals.js"], a["Core/Axis/Tick.js"], a["Core/Utilities.js"]], function (a, y, I, L, C, z, H, B)
    {
        ...
        class Y
        {
            ...
            init(c, f, a = this.coll)
            {
                ...
                this.hasNames = "category" === A || !0 === a.categories;
                ...
                this.labelRotation = b(n.rotation) ? n.rotation : void 0;
                l(this, a);
                k(this, "afterInit")
            }
            ...
            renderSplit(a, d)
            {
                ...
                const f = this
                    ...
                    chart: c, chart: {
                        ...
                        styledMode: G
                    }, distance: x, options: E, options: {positioner: y}
                } = f
        ...
        class G
        {
            ...
            firePointEvent(b, a, c)
            {
                ...
                "click" === b && d.allowPointSelect && (c = function (b)
                    {
                        !f.destroyed && f.select && f.select(null, b.ctrlKey || b.metaKey || b.shiftKey)
                    }
                );
                t(f, b, a, c)
            }
    ...
    M(a, "Core/Series/Series.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Defaults.js"], a["Core/Foundation.js"], a["Core/Globals.js"], a["Core/Legend/LegendSymbol.js"], a["Core/Series/Point.js"], a["Core/Series/SeriesDefaults.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Renderer/SVG/SVGElement.js"], a["Core/Utilities.js"]], function (a, y, I, L, C, z, H, B, u, v)
    {
        ...
        class aa
        {
            ...
            findPointIndex(b, a)
            {
                ...
                k && (h = k && k.index,
                "undefined" !== typeof h && (n = !0));
                "undefined" === typeof h && T(f) && (h = this.xData.indexOf(f, a));
                -1 !== h && "undefined" !== typeof h && this.cropped && (h = h >= this.cropStart ? h - this.cropStart : h);
                !n && T(h) && e[h] && e[h].touched && (h = void 0);
                return h
            }
            ...
            updateData(b, a)
            {
                ...
                {
                    var n = r(b) && this.pointClass.prototype.optionsToObject.call({
                        series: this
                    }, b) || {};
                    const m = n.x;
                    if (n.id || T(m))
                    {
                        if (n = this.findPointIndex(n, l),
                            -1 === n || "undefined" === typeof n ? e.push(b) : f[n] && b !== c.data[n] ? (f[n].update(b, !1, null, !1),
                                f[n].touched = !0,
                            g && (l = n + 1)) : f[n] && (f[n].touched = !0),
                        !k || a !== n || d && d.enabled || this.hasDerivedData)
                        {
                            h = !0
                        }
                    }
                ...
                if (h)
                {
                    for (b = f.length; b--;)
                    {
                        (n = f[b]) && !n.touched && n.remove && n.remove(!1, a);
                    }
                }
                else
                {
            ...
            setData(a, c = !0, d, f)
            {
                ...
                l.options.chart.allowMutatingData && !1 !== f && N && n && !g.cropped && !g.hasGroupedData && g.visible && !g.boosted && (v = this.updateData(a, d));
                if (!v)
                {
                    g.xIncrement = null;
                    g.colorCounter = 0;
            ...
            getProcessedData(a)
            {
                ...
                if (n && c.sorted && !g && (!e || q > e || c.forceCrop))
                {
                    if (a[q - 1] < l || a[0] > r)
                    {
                        a = [],
            ...
            setState(b, a)
            {
                    ...
                    !c.chart.styledMode))
                {
                    ...
                    b && (n = g[b].lineWidth || n + (g[b].lineWidthPlus || 0),
                        l = A(g[b].opacity, l));
                    if (f && !f.dashstyle && T(n))
                    {
                        for (d = {
                            "stroke-width": n
                        },
                                 f.animate(d, k); c["zone-graph-" + h];)
                        {
                            c["zone-graph-" + h].animate(d, k),
                                h += 1;
                        }
                    }
        ...
        class ea
        {
            ...
            isInsidePlot(b, a, c = {})
            {
                ...
                if (!c.ignoreX)
                {
                    ...
                    q >= Math.max(n + e, a.pos) && q <= Math.min(n + e + m.width, a.pos + a.len) || (b.isInsidePlot = !1)
                }
                !c.ignoreY && b.isInsidePlot && (n = !d && c.axis && !c.axis.isXAxis && c.axis || l && (d ? l.xAxis : l.yAxis) || {
                    pos: g,
                    len: Infinity
                },
                    c = c.paneCoordinates ? n.pos + a : g + a,
                c >= Math.max(h + g, n.pos) && c <= Math.min(h + g + m.height, n.pos + n.len) || (b.isInsidePlot = !1));
                ...
                ["title", "subtitle", "caption"].forEach(function (b)
                {
                    ...
                    if (f)
                    {
                        ...
                        const k = c.fontMetrics(f).b
                            , n = Math.round(f.getBBox(e.useHTML).height);
                        f.align(V({
                            y: "bottom" === g ? k : b + k,
                            height: n
                        }, e), !1, "spacingBox");
                        e.floating || ("top" === g ? a[0] = Math.ceil(a[0] + n) : "bottom" === g && (a[2] = Math.ceil(a[2] + n)))
                    }
                }, this);
        ...
        (function (a)
            {
                            ...
                            a.forEach(a =>
                                {
                                    ...
                                    A.forEach((b, f) =>
                                        {
                                            var l, n = b.enabled && (!a.isNull || a.dataLabelOnNull) && g(a, b);
                                            const m = a.connectors ? a.connectors[f] : a.connector
                                                , q = b.style || {};
                                            let r = {}
                                                , w = c[f]
                                                , u = !w;
                                            ...
                                            !w || n && z(F) && !!w.div === !!b.useHTML && (w.rotation && b.rotation || w.rotation === b.rotation) || (w = void 0,
                                                u = !0,
                                            m && a.connector && (a.connector = a.connector.destroy(),
                                            a.connectors && (1 === a.connectors.length ? delete a.connectors : delete a.connectors[f])));
                                            n && z(F) && (w ? r.text = F : (w = A ? h.text(F, 0, 0, b.useHTML).addClass("highcharts-data-label") : h.label(F, 0, 0, b.shape, void 0, void 0, b.useHTML, void 0, "data-label")) && w.addClass(" highcharts-data-label-color-" + a.colorIndex + " " + (b.className || "") + (b.useHTML ? " highcharts-tracker" : "")),
                                            w && (w.options = b,
                                                w.attr(r),
                                            e.styledMode || w.css(q).shadow(b.shadow),
                                            (n = b[a.formatPrefix + "TextPath"] || b.textPath) && !b.useHTML && (w.setTextPath((null === (l = a.getDataLabelPath) || void 0 === l ? void 0 : l.call(a, w)) || a.graphic, n),
                                            a.dataLabelPath && !n.enabled && (a.dataLabelPath = a.dataLabelPath.destroy())),
                                            w.added || w.add(y),
                ...
                function k(a, d, c, e, g, k)
                {
                    ...
                    let {x: n = 0, y: m = 0} = d, p, q;
                    p = (c.x || 0) + l;
                    0 > p && ("right" === f && 0 <= n ? (d.align = "left",
                        d.inside = !0) : n -= p,
                        q = !0);
                    p = (c.x || 0) + e.width - l;
                    p > b.plotWidth && ("left" === f && 0 >= n ? (d.align = "right",
                        d.inside = !0) : n += b.plotWidth - p,
                        q = !0);
                    p = c.y + l;
                    0 > p && ("bottom" === h && 0 <= m ? (d.verticalAlign = "top",
                        d.inside = !0) : m -= p,
                        q = !0);
                    p = (c.y || 0) + e.height - l;
                    p > b.plotHeight && ("top" === h && 0 >= m ? (d.verticalAlign = "bottom",
                        d.inside = !0) : m += b.plotHeight - p,
                        q = !0);
                    q && (d.x = n,
                        d.y = m,
                        a.placed = !k,
                        ...
                        y.forEach((d, k) =>
                            {
                                ...
                                if (n)
                                {
                                    ...
                                    for (W = 0; W < n; W++)
                                    {
                                        ...
                                        O = r = M.natural.y;
                                        m && l(C.distributeBox) && ("undefined" === typeof C.distributeBox.pos ? S = "hidden" : (J = C.distributeBox.size,
